...
declare module 'XrFrame' {
    ...
    export {
        ...
        IAttachmentAction,
        IClearOptions,
        IDescriptorGroupLayoutOptions,
        IShaderTextureOptions,
        ITextureSubRegion,
    ...
    export type HIDSystem = xrFrameSystem.HIDSystem;
    ...
    export type XRSystem = xrFrameSystem.XRSystem;
    export type ShareSystem = xrFrameSystem.ShareSystem;
    export type GizmoSystem = xrFrameSystem.GizmoSystem;
    export type AssetLoader<T, O> = xrFrameSystem.AssetLoader<T, O>;
    ...
    export interface IXrFrameSystem {
        ...
        HIDSystem: typeof xrFrameSystem.HIDSystem;
        ...
        XRSystem: typeof xrFrameSystem.XRSystem;
        ...
        EBufferType: typeof xrFrameSystem.EBufferType;
        EBufferUsage: typeof xrFrameSystem.EBufferUsage;
        EDracoErrorCode: typeof xrFrameSystem.EDracoErrorCode;
        EStoreAction: typeof xrFrameSystem.EStoreAction;
        EUniformBlockType: typeof xrFrameSystem.EUniformBlockType;
        ETextureUsage: typeof xrFrameSystem.ETextureUsage;
        ETextureSampledType: typeof xrFrameSystem.ETextureSampledType;
        EUniformUsage: typeof xrFrameSystem.EUniformUsage;
        ...
        XRSystemSchema: IComponentSchema
...
declare module 'XrFrame/xrFrameSystem' {
    /**
      ...
      */
    import { Konata } from 'XrFrame/ext';
    ...
    export { registerEffect, registerGeometry, registerTexture, registerMaterial, registerUniformDesc, registerVertexLayout } from 'XrFrame/assets/factories';
    ...
    export { ITextureOptions, IEngineSettings, EVertexFormat, EVertexStep, EIndexType, ETextureType, ETextureFormat, EWrapMode, EFilterMode, EUniformType, ECullMode, EFaceWinding, ECompareFunc, EStencilOp, EBlendFactor, EBlendEquation, EColorMask, EPixelType, ELoadAction, EDataModelType, EMeshRenderType, EPrimitiveType, EShadowMode, EShadowFitMode, EVertexLayoutUsage, EVertexBatchOperator, EAnimationBlendType, EUseDefaultAddedAction, EUseDefaultRetainedAction, EUseDefaultRemovedAction, EBufferType, EBufferUsage, EDracoErrorCode, EStoreAction, EUniformBlockType, ETextureUsage, ETextureSampledType, EUniformUsage, IHandle, IVertexLayoutOptions, IVertexDataDescriptorOptions, IUniformDescriptorOptions, IImage, IRealDownloader, IDownloader, IFontSetting, IFeatures, IRect, IVertexBuffOptions, IView, IAttachment, IAttachmentAction, IClearOptions, IDescriptorGroupLayoutOptions, IShaderTextureOptions, ITextureSubRegion, ITextureSamplerOptions, IRenderPassOptions, EEventType, IGlyphInfo, IEventBridge, INativeMap, ILongIntNativeMap, } from 'XrFrame/konata/lib/konata';
    export type Texture = Konata.Texture;
    export type KBuffer = Konata.KBuffer;
    export type UniformDescriptor = Konata.UniformDescriptor;
    export type UniformBlock = Konata.UniformBlock;
    export type VertexLayout = Konata.VertexLayout;
...
declare module 'XrFrame/ext' {
    /**
      ...
      */
    import * as Konata from 'XrFrame/konata/lib/konata';
    const exparser: any;
    type Scene = import('XrFrame/core/Scene').default;
    const _wx: any;
    const Phys3D: any;
    function addKonata(scene: Scene, konata: Konata.IKonataInstance): void;
    function removeKonata(scene: Scene): void;
    function getKonata(scene: Scene): Konata.IKonataInstance;
    function __getKonataSuperHackDontUseIt(): Konata.IKonataInstance;
    export { Konata, exparser, Phys3D, _wx, addKonata, removeKonata, getKonata, __getKonataSuperHackDontUseIt };
}

declare module 'XrFrame/core/Component' {
    import HIDSystem from 'XrFrame/systems/HIDSystem';
    ...
    export default class Component<IData> {
            ...
            /**
                * HID输入变化时的回调。
                */
            onHID(hid: HIDSystem, data: IData): void;
            /**
...
declare module 'XrFrame/systems' {
    ...
    export { default as HIDSystem, IHIDSystemData } from 'XrFrame/systems/HIDSystem';
    ...
    export { default as XRSystem, IXRSystemData, XRSystemSchema } from 'XrFrame/systems/XRSystem';
...
declare module 'XrFrame/assets/Effect' {
    ...
    export interface IRenderStates {
            ...
            /**
                * 不要使用，使用`blendSrcRGB`。
                */
            blendSrc?: Konata.EBlendFactor;
            blendSrcRGB?: Konata.EBlendFactor;
            blendSrcAlpha?: Konata.EBlendFactor;
            /**
                * 不要使用，使用`blendDstRGB`。
                */
            blendDst?: Konata.EBlendFactor;
            blendDstRGB?: Konata.EBlendFactor;
            blendDstAlpha?: Konata.EBlendFactor;
            blendFunc?: Konata.EBlendEquation;
            cullOn?: boolean;
            cullFace?: Konata.ECullMode;
            depthWrite?: boolean;
            depthTestOn?: boolean;
            depthTestComp?: Konata.ECompareFunc;
            /**
                * 在基础库版本`v2.31.1`以上支持。
                */
            colorWrite?: number;
            ...
            stencilComp?: Konata.ECompareFunc;
            stencilPass?: Konata.EStencilOp;
            stencilFail?: Konata.EStencilOp;
            stencilZFail?: Konata.EStencilOp;
            primitiveType?: Konata.EPrimitiveType;
    }
    /**
        * `Effect`资源的参数接口。
        */
    export interface IEffectAsset {
            ...
            images?: Array<{
                    ...
                    key: string;
                    /**
                        * 纹理默认值，是`Texture`类型资源的`asset-id`。
                        */
                    default: string;
                    /**
                        * 纹理对应的宏，当默认值被覆盖时，此宏开关会被开启，注意一定要有`WX_`前缀！
                        */
                    macro?: string;
                    /**
                        * 纹理类型，默认为`ETextureType.2D`，除此之外的必须要改！
                        */
                    type?: Konata.ETextureType;
            }>;
            /**
                * 额外的属性集合，完全由开发者自己操控数据，可以用于Instance等实现。
                * 通过{@link Material.getOrCreateExtraBuffer}获取用于使用的`buffer`和`offsets`，自行维护。
                */
            extraProperties?: Array<{
                    /**
                        * 写入到Shader中UB的名字，必须为`ub{NAME}`的形式。
                        */
                    name: string;
                    /**
                        * 属性列表。
                    ...
                    properties: Array<{
                            ...
                            /**
                                * 如果属性是一个数组，比如`FLOAT4`数组，可以指定数组大小。
                                * 如果是`Infinite`则为不定长，不定长数组必须写在最后。
                                */
                            num?: number;
                    }>;
            }>;
    ...
    export default class Effect {
            ...
            /**
                ...
                * @internal
                */
            get konataEffect(): import('XrFrame/konata/lib/index').Effect;
            /**
                * 有几个Pass。
                */
            ...
            /**
                ...
                */
            get loadingTextures(): {
                    [key: string]: IAssetWithState<import('XrFrame/konata/lib/index').Texture | ITextureWrapper>;
            };
            /**
                * 用于UniformBlock构建时传入
                * @internal
                */
            _shaderUniformBlockDesc?: Konata.UniformDescriptor;
            /**
                * 是否没有properties。
                * @internal
                */
...
declare module 'XrFrame/assets/Geometry' {
    ...
    export default class Geometry {
            ...
            /**
                * 获取IndexBuffer。
                */
            get indexBuffer(): import('XrFrame/konata/lib/index').IndexBuffer;
            /**
                * 获取VertexBuffer。
                */
            get vertexBuffer(): import('XrFrame/konata/lib/index').VertexBuffer;
            /**
            ...
            /**
                * 构造一个`Geometry`。
                */
            constructor(_scene: Scene, vertexLayout: Konata.VertexLayout, vBuffer: ArrayBufferView, iBuffer: ArrayBufferView, indexType?: Konata.EIndexType);
            /**
            ...
            /**
                * 获取VertexLayout。
                */
            getVertexLayout(): Konata.VertexLayout;
            /**
                * 修改subMesh。
                *
                * @param length 索引长度
...
declare module 'XrFrame/assets/Material' {
    ...
    export default class Material {
            /**
                * @internal
                */
            get konataMaterial(): import('XrFrame/konata/lib/index').Material;
            /**
                * @internal
                */
            get uniforms(): import('XrFrame/konata/lib/index').UniformBlock;
            ...
            /**
                * 开启材质Instance功能，并设置数量！
                * 同时会开启`WX_USE_INSTANCE`宏。
                */
            ...
            initByEffect(effect: Effect, defaultUniforms?: {
                    [key: string]: ArrayLike<number> | number | Konata.Texture;
            }): void;
            /**
                * 获取一个Float
                */
            ...
            /**
                ...
                * @returns 是否设置成功。
                */
            setTexture(key: string, value: Konata.Texture): boolean;
            /**
             * 设置一张贴图。
             *
             * @returns 是否设置成功。
            ...
            resetTexture(key: string): import('XrFrame/konata/lib/index').Texture;
            /**
            ...
            /**
                * 获取材质中已设置的贴图。
                */
            getTexture(key: string): Konata.Texture;
            /**
                * 设置渲染状态。
            ...
            /**
                * 获取或创建某个`extraProperties`的Buffer。
                */
            getOrCreateExtraBuffer(name: string, dynamicArrayByteSize: number): {
                    buffer: import('XrFrame/konata/lib/index').KBuffer;
                    byteSize: number;
                    byteOffsets: {
...
declare module 'XrFrame/assets/VideoTexture' {
    ...
    export default class VideoTexture {
            onEnd?: () => void;
            get texture(): import('XrFrame/konata/lib/index').Texture;
            get width(): number;
            get height(): number;
...
declare module 'XrFrame/assets/RenderTexture' {
    ...
    export interface IRenderTextureOptions {
            ...
            height: number;
            isHDR?: boolean;
            format?: Konata.ETextureFormat;
            minFilter?: Konata.EFilterMode;
            magFilter?: Konata.EFilterMode;
    }
    /**
    ...
    export default class RenderTexture {
            ...
            /**
                ...
                * @internal
                */
            get depthStencil(): import('XrFrame/konata/lib/index').Texture;
            /**
                * 获取第一个色彩纹理。
                * @internal
                */
            ...
            /**
                ...
                * @internal
                */
            get depthTexture(): import('XrFrame/konata/lib/index').Texture;
            /**
                * 获取Backend实例。
                * @internal
                */
            get renderPass(): import('XrFrame/konata/lib/index').RenderPass;
            /**
                * 贴图高。
                */
            get height(): number;
...
declare module 'XrFrame/assets/EnvData' {
    ...
    export default class EnvData {
            ...
            get skyboxMap(): import('XrFrame/konata/lib/index').Texture;
            ...
            get specularMap(): import('XrFrame/konata/lib/index').Texture;
...
declare module 'XrFrame/assets/Atlas' {
    ...
    export default class Atlas {
            ...
            protected _image: Konata.IImage;
            protected _texture: Konata.Texture;
            ...
            static CREATE_FROM_GRIDS(scene: Scene, options: {
                    ...
                    cols: number;
                    space?: number;
            }, onUpdate?: (texture: Konata.Texture, region: {
                    col: number;
                    row: number;
                    x: number;
                    y: number;
            ...
            /**
                ...
                */
            static CREATE_FROM_TEXTURE(scene: Scene, texture: Konata.Texture, options: IAtlasCreationOptions): Atlas;
            /**
                * 获取元信息。
                */
            get meta(): {
            ...
            /**
                ...
                */
            updateFrame(frameName: string, onUpdate: (texture: Konata.Texture, region: {
                    x: number;
                    y: number;
                    w: number;
                    h: number;
...
declare module 'XrFrame/assets/factories' {
    ...
    /**
        * 注册`Texture`资源。
        */
    export const registerTexture: (id: string, factory: (scene: Scene) => import('XrFrame/konata/lib/index').Texture) => void;
    /**
        * 注册`TextureCube`资源。
        */
    export const registerTextureCube: (id: string, factory: (scene: Scene) => import('XrFrame/konata/lib/index').Texture) => void;
    /**
        * 注册`UniformDescriptor`资源。
        */
    export const registerUniformDesc: (id: string, factory: (scene: Scene) => import('XrFrame/konata/lib/index').UniformDescriptor) => void;
    /**
        * 注册`VertexLayout`资源。
        */
    export const registerVertexLayout: (id: string, factory: (scene: Scene) => import('XrFrame/konata/lib/index').VertexLayout) => void;
    /**
        * 注册`Material`资源。
        */
...
declare module 'XrFrame/math/vector3' {
    ...
    export default class Vector3 {
            ...
            /**
                ...
                * @memberof Vector3
                */
            static createFromArray(array: ArrayLike<number>): Vector3;
            /**
                * 使用某个已有的typedArray创建
                * 此操作不会拷贝数据，而是在原来的内存区域上操作
                *
...
declare module 'XrFrame/math/quaternion' {
    ...
    export default class Quaternion {
            ...
            /**
                ...
                * @memberof Quaternion
                */
            static createFromArray(array: ArrayLike<number>): Quaternion;
            /**
                * 使用某个已有的typedArray创建
                * 此操作不会拷贝数据，而是在原来的内存区域上操作
                *
...
declare module 'XrFrame/math/matrix4' {
    ...
    export default class Matrix4 {
            ...
            /**
                ...
                * @memberof Matrix4
                */
            composeTRS(translation: V3ReadOnly, rotation: Matrix4, scale: V3ReadOnly): Matrix4;
            /**
                * 将位移旋转缩放合成一个RST矩阵，旋转用四元数表示
                *
                * @static
                * @param {V3ReadOnly} translation 位移向量
                * @param {M4ReadOnly} quat 四元数
                * @param {V3ReadOnly} scale 缩放向量
                * @returns {Matrix4} 计算结果
                * @memberof Matrix4
                */
            composeTQS(translation: V3ReadOnly, quat: Quaternion, scale: V3ReadOnly): Matrix4;
            /**
                * 设置该矩阵某行某列的值
                *
...
declare module 'XrFrame/konata/lib/konata' {
    
    import * as IKonata from 'XrFrame/konata/lib/frontend';
    import {IEngineSettings} from 'XrFrame/konata/lib/backend/interface';
    
    export * from 'XrFrame/konata/lib/backend/interface';
    export {ITextureOptions, IRenderPassOptions} from 'XrFrame/konata/lib/index';
    
    export type KBuffer = IKonata.KBuffer;
    export type AnimatorComponent = IKonata.AnimatorComponent;
    export type CameraComponent = IKonata.CameraComponent;
    export type CullingComponent = IKonata.CullingComponent;
    export type MeshRendererComponent = IKonata.MeshRendererComponent;
    export type SkinnedSkeletonComponent = IKonata.SkinnedSkeletonComponent;
    export type DynamicBonesComponent = IKonata.DynamicBonesComponent;
    export type Entity2D = IKonata.Entity2D;
    export type Entity3D = IKonata.Entity3D;
    export type AnimationClipModel = IKonata.AnimationClipModel;
    export type AnimationClipBinding = IKonata.AnimationClipBinding;
    export type AnimatorControllerModel = IKonata.AnimatorControllerModel;
    export type AnimatorControllerStateModel = IKonata.AnimatorControllerStateModel;
    export type DataBuffer = IKonata.DataBuffer;
    export type DataModel = IKonata.DataModel;
    export type Effect = IKonata.Effect;
    export type Material = IKonata.Material;
    export type SkeletonBoneInverseModel = IKonata.SkeletonBoneInverseModel;
    export type UniformBlock = IKonata.UniformBlock;
    export type UniformDescriptor = IKonata.UniformDescriptor;
    export type IndexBuffer = IKonata.IndexBuffer;
    export type VertexBuffer = IKonata.VertexBuffer;
    export type VertexLayout = IKonata.VertexLayout;
    export type ScalableList = IKonata.ScalableList;
    export type RenderPass = IKonata.RenderPass;
    export type Texture = IKonata.Texture;
    export type RenderEnv = IKonata.RenderEnv
    
    export interface IKonataInstance {
        Image: typeof IKonata.Image;
        Downloader: typeof IKonata.Downloader;
        IS_VALID: typeof IKonata.IS_VALID;
        GET_MAIN_CANVAS: typeof IKonata.GET_MAIN_CANVAS;
        Phys3D: typeof IKonata.Phys3D;
        KBuffer: typeof IKonata.KBuffer;
        AnimatorComponent: typeof IKonata.AnimatorComponent;
        CameraComponent: typeof IKonata.CameraComponent;
        CullingComponent: typeof IKonata.CullingComponent;
        MeshRendererComponent: typeof IKonata.MeshRendererComponent;
        SkinnedSkeletonComponent: typeof IKonata.SkinnedSkeletonComponent;
        DynamicBonesComponent: typeof IKonata.DynamicBonesComponent;
        Entity2D: typeof IKonata.Entity2D;
        Entity3D: typeof IKonata.Entity3D;
        AnimationClipModel: typeof IKonata.AnimationClipModel;
        AnimationClipBinding: typeof IKonata.AnimationClipBinding;
        AnimatorControllerModel: typeof IKonata.AnimatorControllerModel;
        AnimatorControllerStateModel: typeof IKonata.AnimatorControllerStateModel;
        DataBuffer: typeof IKonata.DataBuffer;
        DataModel: typeof IKonata.DataModel;
        Effect: typeof IKonata.Effect;
        Material: typeof IKonata.Material;
        SkeletonBoneInverseModel: typeof IKonata.SkeletonBoneInverseModel;
        UniformBlock: typeof IKonata.UniformBlock;
        UniformDescriptor: typeof IKonata.UniformDescriptor;
        IndexBuffer: typeof IKonata.IndexBuffer;
        VertexBuffer: typeof IKonata.VertexBuffer;
        VertexLayout: typeof IKonata.VertexLayout;
        ScalableList: typeof IKonata.ScalableList;
        crossContext: typeof IKonata.crossContext;
        RenderPass: typeof IKonata.RenderPass;
        Texture: typeof IKonata.Texture;
        RenderEnv: typeof IKonata.RenderEnv;
        renderEnv: typeof IKonata.renderEnv;
        xrEnv: typeof IKonata.xrEnv;
        createWeakRef: typeof IKonata.createWeakRef;
        createWeakRefSentry: typeof IKonata.createWeakRefSentry;
        createNativeUUMap: typeof IKonata.createNativeUUMap;
        createNativeSUMap: typeof IKonata.createNativeSUMap;
        createNativeULUMap: typeof IKonata.createNativeULUMap;
        loadTTFFont: typeof IKonata.loadTTFFont;
        getGlyphInfo: typeof IKonata.getGlyphInfo;
        refreshNodesWorldTransform: typeof IKonata.refreshNodesWorldTransform;
        setGlobalPhysicSystem: typeof IKonata.setGlobalPhysicSystem;
        bindRigidBodyToNode: typeof IKonata.bindRigidBodyToNode;
        bindCCTToNode: typeof IKonata.bindCCTToNode;
        unbindRigidBody: typeof IKonata.unbindRigidBody;
        unbindCCT: typeof IKonata.unbindCCT;
        decodeBase64: typeof IKonata.decodeBase64;
        initDraco: typeof IKonata.initDraco;
        decodeDraco: typeof IKonata.decodeDraco;
        setNodeName: typeof IKonata.setNodeName;
        setRenderComponentName: typeof IKonata.setRenderComponentName;
        debugPrint: typeof IKonata.debugPrint;
        eventBridge: typeof IKonata.eventBridge;
        destroy: typeof IKonata.destroy;
        update: typeof IKonata.update
    }
    
    
    export function CREATE_INSTANCE(MAIN_CANVAS: HTMLCanvasElement, ENGINE_SETTINGS: IEngineSettings, ENGINE_MODE: 'Game' | 'Editor', IS_SUB_CONTEXT: boolean, HOST: string, FIX_INSTANCE: boolean): IKonataInstance;
    export function RELEASE_INSTANCE(MAIN_CANVAS: HTMLCanvasElement): void;
}

declare module 'XrFrame/systems/HIDSystem' {
    /**
        * HIDSystem.ts
        *
        *         * @Date    : 2023/9/5 19:35:45
        */
    import Component, { IComponentSchema } from 'XrFrame/core/Component';
    import Element from 'XrFrame/core/Element';
    import Camera from 'XrFrame/components/Camera';
    import Vector3 from 'XrFrame/math/vector3';
    export interface IHIDEvents {
            pointers?: {
                    id: number;
                    pos: Vector3;
                    state: 'Release' | 'Press';
    ...
    export type THIDEvent = keyof IHIDEvents;
    export interface IHIDSystemData {
    }
    /**
        * {@link HIDSystem}的`schema`，详见{@link IHIDSystemData}。
        */
    export const XRSystemSchema: IComponentSchema;
    /**
        * HID系统，负责整个场景的外部输入。
        */
    export default class HIDSystem extends Component<IHIDSystemData> {
            readonly priority: number;
            /**
                * 触摸点、鼠标指针、XR模式的控制器位置、XR模式的人手位置。
                */
            getPointers(): void;
            /**
                * PC是滚轮，触摸是两指。
            ...
            getZoom(): void;
            /**
                * XR模式人手前向/控制器方向/相机前向（降级）。
                * 其他模式触摸点、鼠标指针换算。
                * `camera`不传则为第一个相机，XR模式不需要。
                */
            getRays(camera?: Camera): {
                    id: number;
                    origin: Vector3;
                    dir: Vector3;
            }[];
            ...
            getActions(): Map<string, {
                    id: number;
                    value?: number;
            }[]>;
            onAdd(parent: Element, data: IHIDSystemData): void;
            onTick(deltaTime: number, data: IHIDSystemData): void;
    }
}
...
declare module 'XrFrame/core/Scene' {
    ...
    import { GizmoSystem, ShareSystem, VideoSystem, HIDSystem, XRSystem } from 'XrFrame/systems';
    ...
    export default class Scene extends Element {
            ...
            /**
                * @internal
                */
            get renderPass(): Konata.RenderPass;
            /**
                * @internal
             */
            get rootNode(): import('XrFrame/konata/lib/index').Entity3D;
            /**
                * @internal
             */
            ...
            /**
                ...
                */
            createImage(autoRelease?: boolean): Konata.IImage;
            /**
                * 手动创建一个`Texture`资源。
                */
            createTexture(options: Konata.ITextureOptions): Konata.Texture;
            /**
                * 手动创建一个`Effect`资源。
                */
            ...
            /**
                ...
                */
            createUniformBlockDesc(options: Konata.IDescriptorGroupLayoutOptions): Konata.UniformDescriptor;
            /**
                * 手动创建一个`UniformBlock`资源。
                */
            createUniformBlock(descriptor: Konata.UniformDescriptor): Konata.UniformBlock;
            /**
                * 手动创建一个`Material`资源。
                */
            createMaterial(effect: Effect, defaultUniforms?: {
                    [key: string]: number | ArrayLike<number> | Konata.Texture;
            }): Material;
            /**
                * 手动创建一个`VertexLayout`资源。
                */
            createVertexLayout(options: Konata.IVertexLayoutOptions): Konata.VertexLayout;
            /**
                * 手动创建一个`Geometry`资源。
                */
            createGeometry(vertexLayout: Konata.VertexLayout, vBuffer: ArrayBufferView, iBuffer: ArrayBufferView, indexType?: Konata.EIndexType): Geometry;
            /**
...
declare module 'XrFrame/components/Transform' {
    ...
    export default class Transform extends Component<ITransformData> {
            ...
            readonly schema: IComponentSchema;
            readonly priority: number;
            get node(): import('XrFrame/konata/lib/index').Entity3D;
            /**
                * 获取世界矩阵，**注意不可修改**。
                */
...
declare module 'XrFrame/components/Camera' {
    ...
    export default class Camera extends Component<ICameraData> {
            ...
            /**
                * @internal
                */
            get view(): Konata.IView;
            /**
                * @internal
                */
            set view(view: Konata.IView);
            /**
                * @internal
                */
            get clearActions(): Konata.IAttachmentAction[];
            /**
                * @internal
                */
            set clearActions(actions: Konata.IAttachmentAction[]);
            /**
                * @internal
                */
            get id(): number;
            ...
            /**
                * @internal
                */
            cull(cullResult: Konata.ScalableList, lightMode: string): void;
            /**
                * @internal
                */
            clear(renderTarget: IRenderTarget, actions?: Konata.IAttachmentAction[]): void;
            /**
                * @internal
                */
            draw(renderList: Konata.ScalableList, lightMode: string, renderTarget: IRenderTarget, drawStart?: number, drawEnd?: number, viewport?: Konata.IRect): void;
            /**
                * 将世界坐标系位置转换到齐次裁剪空间。
                */
...
declare module 'XrFrame/components/Mesh' {
    ...
    export default class Mesh extends Component<IMeshData> {
            ...
            readonly schema: IComponentSchema;
            readonly priority: number;
            protected _cull: Konata.CullingComponent;
            protected _mesh: Konata.MeshRendererComponent;
            ...
            /**
                * @internal
                */
            protected _getUniformDesc(): Konata.UniformDescriptor;
            /**
                * @internal
                */
            protected _getMeshType(): Konata.EMeshRenderType;
    }
}
...
declare module 'XrFrame/components/text/Text' {
    ...
    export default class Text extends Component<ITextData> {
            ...
            static QueryGlyphs: (scene: import('XrFrame/core/Scene').default, characters: string, italic: boolean, bold: boolean, fontSize: number, fontFamily: string) => IGlyph[];
            ...
            protected _getUniformDesc(): Konata.UniformDescriptor;
            protected _getMeshType(): Konata.EMeshRenderType;
            protected _getVertexLayout(): Konata.VertexLayout;
    }
}
...
declare module 'XrFrame/components/particle/BasicParticle' {
    ...
    export default class BasicParticle extends Component<IParticleData> {
            ...
            protected _textureData: Konata.Texture;
            protected _atlasObj: Atlas;
            protected _atlasTexture: Konata.Texture;
            protected _cull: Konata.CullingComponent;
            protected _mesh: Konata.MeshRendererComponent;
            protected _sourceMaterial: Material;
            protected _material: Material;
            protected _trs: Transform;
            protected _vertexBuffer: Konata.VertexBuffer;
            protected _indexBuffer: Konata.IndexBuffer;
            ...
            protected _rampGradientsTexture: Konata.Texture;
            ...
            */
            ...
            protected _getUniformDesc(): Konata.UniformDescriptor;
            protected _getMeshType(): Konata.EMeshRenderType;
            protected _getVertexLayout(attributes: any, stride: any): Konata.VertexLayout;
...
declare module 'XrFrame/components/Env' {
    ...
    export interface IEnvData {
            ...
            /**
                ...
                */
            skyMap?: Konata.Texture | ITextureWrapper;
            /**
    ...
    export default class Env extends Component<IEnvData> {
            ...
            readonly schema: IComponentSchema;
            get useHalfSkyMap(): boolean;
            get skyMap(): import('XrFrame/konata/lib/index').Texture;
            get isSky2D(): boolean;
            get isSkyRT(): boolean;
            get rotation(): number;
            get hasDiffuse(): boolean;
...
declare module 'XrFrame/systems/PhysicsSystem' {
    ...
    export default class PhysicsSystem extends Component<IPhysicsSystemData> {
            ...
            /**
                * @internal
                */
            bindRigidbodyWithEntity(rigidbody: phys3D.Rigidbody, entity: Konata.Entity3D): void;
            /**
                * @internal
                */
...
declare module 'XrFrame/systems/XRSystem' {
    /**
        * XRSystem.ts
        *
        *         * @Date    : 2023/7/7 17:14:40
        */
    import { Konata } from 'XrFrame/ext';
    import { Camera } from 'XrFrame/components';
    import { IRenderTarget } from 'XrFrame/assets/RenderTexture';
    ...
    /**
        * `XRSystem`系统数据接口。
        */
    export interface IXRSystemData {
    }
    /**
        * {@link XRSystem}的`schema`，详见{@link IXRSystemData}。
        */
    export const XRSystemSchema: IComponentSchema;
    /**
        * XR系统，负责整个场景XR相关对象的管理。
        */
    export default class XRSystem extends Component<IXRSystemData> {
            static EVENTS: string[];
            /**
                * 详见{@link XRSystemSchema}。
                */
            readonly schema: IComponentSchema;
            readonly priority: number;
            /**
            ...
            getRenderTarget(index: number): IRenderTarget;
            checkShoesInfo(): Konata.IXRShoesInfo;
            onAdd(parent: Element, data: IXRSystemData): void;
            onTick(deltaTime: number, data: IXRSystemData): void;
            onRelease(data: IXRSystemData): void;
            /**
                * @internal
                */
            /**
...
declare module 'XrFrame/loader/TextureLoader' {
    ...
    import { IAssetLoadData } from 'XrFrame/loader/types';
    export function isPOT(img: Konata.IImage): boolean;
    /**
    ...
    /**
        ...
        */
    export default class TextureLoader extends AssetLoader<Konata.Texture, ITextureLoaderOptions> {
            readonly schema: ILoaderOptionsSchema;
            load(params: ITextureLoadData, callbacks: {
                    onLoading(progress: number): void;
                    onLoaded(value: Konata.Texture): void;
                    onError(error: Error): void;
            }): void;
            getBuiltin(): {
                    assetId: string;
            ...
            release(params: ITextureLoadData, value: Konata.Texture): void;
    }
    export {};
}
...
declare module 'XrFrame/loader/ImageLoader' {
    ...
    /**
        ...
        */
    export default class ImageLoader extends AssetLoader<Konata.IImage, IImageLoaderOptions> {
            readonly schema: ILoaderOptionsSchema;
            load(params: IImageLoadData, callbacks: {
                    onLoading(progress: number): void;
                    onLoaded(value: Konata.IImage): void;
                    onError(error: Error): void;
            }): void;
            release(params: IImageLoadData, value: Konata.IImage): void;
    }
    export {};
}
...
declare module 'XrFrame/loader/CubeTextureLoader' {
    ...
    /**
        ...
        */
    export default class CubeTextureLoader extends AssetLoader<Konata.Texture, ICubeTextureLoaderOptions> {
            /**
            ...
            release(params: ICubeTextureLoadData, value: Konata.Texture): void;
    }
    export {};
}
...
declare module 'XrFrame/loader/EnvDataLoader' {
    ...
    /**
        ...
        * 加载的资源一般由[xr-frame-toolkit](https://github.com/wechat-miniprogram/xr-frame-toolkit)生成。
        */
...
declare module 'XrFrame/animation/NativeAnimation' {
    ...
    export interface INativeAnimationData {
        clip: Konata.AnimationClipModel;
        bindings: Array<Konata.Entity3D>;
        frameCount: number;
        names: string[];
        simulators?: Array<{
...
declare module 'XrFrame/konata/lib/frontend' {
    import MeshRendererComponent from 'XrFrame/konata/lib/frontend/component/MeshRendererComponent';
    import renderEnv from 'XrFrame/konata/lib/frontend/resource/renderEnv';
    export { RenderEnv } from 'XrFrame/konata/lib/frontend/resource/renderEnv';
    export { default as KBuffer } from 'XrFrame/konata/lib/frontend/resource/KBuffer';
    export { default as AnimatorComponent } from 'XrFrame/konata/lib/frontend/component/AnimatorComponent';
    export { default as CameraComponent } from 'XrFrame/konata/lib/frontend/component/CameraComponent';
    export { default as CullingComponent } from 'XrFrame/konata/lib/frontend/component/CullingComponent';
    export { default as MeshRendererComponent } from 'XrFrame/konata/lib/frontend/component/MeshRendererComponent';
    export { default as SkinnedSkeletonComponent } from 'XrFrame/konata/lib/frontend/component/SkinnedSkeletonComponent';
    export { default as DynamicBonesComponent } from 'XrFrame/konata/lib/frontend/component/DynamicBonesComponent';
    export { default as Entity2D } from 'XrFrame/konata/lib/frontend/entity/Entity2D';
    export { default as Entity3D } from 'XrFrame/konata/lib/frontend/entity/Entity3D';
    export { default as AnimationClipModel } from 'XrFrame/konata/lib/frontend/resource/AnimationClipModel';
    export { default as AnimationClipBinding } from 'XrFrame/konata/lib/frontend/resource/AnimationClipBinding';
    export { default as AnimatorControllerModel } from 'XrFrame/konata/lib/frontend/resource/AnimatorControllerModel';
    export { default as AnimatorControllerStateModel } from 'XrFrame/konata/lib/frontend/resource/AnimatorControllerStateModel';
    export { default as DataBuffer } from 'XrFrame/konata/lib/frontend/resource/DataBuffer';
    export { default as DataModel } from 'XrFrame/konata/lib/frontend/resource/DataModel';
    export { default as Effect } from 'XrFrame/konata/lib/frontend/resource/Effect';
    export { default as Material } from 'XrFrame/konata/lib/frontend/resource/Material';
    export { default as RenderPass, IRenderPassOptions } from 'XrFrame/konata/lib/frontend/resource/RenderPass';
    export { default as SkeletonBoneInverseModel } from 'XrFrame/konata/lib/frontend/resource/SkeletonBoneInverseModel';
    export { default as Texture, ITextureOptions } from 'XrFrame/konata/lib/frontend/resource/Texture';
    export { default as UniformBlock } from 'XrFrame/konata/lib/frontend/resource/UniformBlock';
    export { default as UniformDescriptor } from 'XrFrame/konata/lib/frontend/resource/UniformDescriptor';
    export { default as IndexBuffer } from 'XrFrame/konata/lib/frontend/resource/IndexBuffer';
    export { default as VertexBuffer } from 'XrFrame/konata/lib/frontend/resource/VertexBuffer';
    export { default as VertexLayout } from 'XrFrame/konata/lib/frontend/resource/VertexLayout';
    export { default as ScalableList } from 'XrFrame/konata/lib/frontend/resource/ScalableList';
    export { default as crossContext } from 'XrFrame/konata/lib/frontend/shared/crossContext';
    const IS_VALID: () => boolean, GET_MAIN_CANVAS: () => HTMLCanvasElement, Image: {
        new (): import('XrFrame/konata/lib/backend').IImage;
        IS(obj: any): obj is import('XrFrame/konata/lib/backend').IImage;
    }, Phys3D: any;
    const downloader: import('XrFrame/konata/lib/backend').IDownloader;
    export const xrEnv: import('XrFrame/konata/lib/backend').IXREnv;
    export { renderEnv };
    ...
    export const createNativeUUMap: () => import('XrFrame/konata/lib/backend').INativeMap<number>;
    export const createNativeSUMap: () => import('XrFrame/konata/lib/backend').INativeMap<string>;
    export const createNativeULUMap: () => import('XrFrame/konata/lib/backend').ILongIntNativeMap;
    export const loadTTFFont: (url: string, callback: (font: string) => void) => void;
    export const getGlyphInfo: (fontSetting: import('XrFrame/konata/lib/backend').IFontSetting, charCode: number) => import('XrFrame/konata/lib/backend').IGlyphInfo;
    ...
    export const decodeDraco: (buffer: ArrayBuffer | ArrayBufferView, decodeType: import('XrFrame/konata/lib/backend').EDracoDecodeType) => import('XrFrame/konata/lib/backend').DracoDecoded;
...
declare module 'XrFrame/konata/lib/backend/interface' {
    /**
        * index.ts
        *
    ...
    /**
        ...
        * 目前只能用F32。
        */
    export enum ETextureSampledType {
            float = 0,
            int = 1,
            uint = 2,
    ...
    export enum EBufferType {
            ...
            GPULocal = 0,
            /**
                * 同时维护一块gpu buffer和一块cpu memory，可通过共享内存方式拿到cpu memory，如果用在Uniform里，绘制指令的时候会自动Upload()。
                */
            DoubleBuffer = 1,
            CPUVisible = 2
    }
    ...
    /**
        ...
        * 中间产物，首字母小写方便转换。
        */
    export enum EUniformBaseFormat {
            f32 = 0,
            f16 = 1,
            u32 = 2,
            i32 = 3
    ...
    /**
        * Uniform的矢量类型。
        */
    export enum EUniformVectorType {
            scalar = 0,
            vec2 = 1,
            vec3 = 2,
            vec4 = 3,
    ...
    export const RENDER_ENV_OFFSETS: {
            ...
            faultTexture2D: number;
            faultTextureCube: number;
            faultTexture3D: number;
            faultEffect: number;
    };
    ...
    /**
        * 顶点数据创建参数。
        */
    export interface IVertexBuffOptions {
            buffer: IHandle;
            byteOffset: number;
            layout: IHandle;
    }
    /**
        * 索引数据创建参数。
        */
    export interface IIndexBuffOptions {
            buffer: IHandle;
            byteOffset: number;
            type: EIndexType;
    }
    ...
    /**
        * 纹理更新区域参数。
        */
    export interface ITextureSubRegion {
            slice?: number;
            level?: number;
            xoffset?: number;
            yoffset?: number;
    ...
    /**
        * 纹理创建参数。
        */
    export interface IKTextureOptions {
            usage: number;
            type: ETextureType;
            width: number;
            height: number;
            ...
            mipLevels: number;
            generateMipmaps: boolean;
            sampler: ITextureSamplerOptions;
            slices?: number;
            isUI?: boolean;
    }
    /**
    ...
    export interface IUniformDescriptorOptions {
            ...
            uniforms: {
                    ...
                    /**
                        ...
                        * @internal
                        */
                    baseFormat?: EUniformBaseFormat;
                    /**
                        * 矢量类型，自动转换。
                        * @internal
                        */
                    vectorType?: EUniformVectorType;
            }[];
    }
    /**
        * DescriptorGroup中的纹理定义。
        */
    export interface IShaderTextureOptions {
            name: string;
            type: ETextureType;
            sampledType: ETextureSampledType;
            num: 1;
    }
    /**
        * DescriptorGroupLayout的参数定义。
        */
    export interface IDescriptorGroupLayoutOptions {
            uniformBlocks: IUniformDescriptorOptions[];
            textures: IShaderTextureOptions[];
    }
    /**
        * 引擎原生图片接口。
        */
    export interface IImage {
            ...
            /**
                * 解码数据，视不同Backend而定。
                */
            readonly data?: ArrayBuffer | ImageBitmap;
    }
    /**
        * 清屏参数。
        */
    ...
    /**
        * 相机绘制参数。
        */
    export interface IDrawCameraOptions {
            camera: IHandle;
            objects: IHandle;
            lightMode: string;
            view: IView;
            renderPass: IHandle;
            /**
                * 在WebGPU Backend，这个参数没用，因为前端RT创建RenderPass和画的时候完全一致。
                */
            attachments?: IAttachment[];
            actions: IAttachmentAction[];
            drawStart?: number;
    ...
    /**
        * CSM灯光剔除参数。
        */
    export interface ICullLightCSMOptions {
            camera: IHandle;
            /**
            ...
            params: Float32Array;
            /**
                * |start0|end0|start1|end1|start2|end2|start3|end3|
    ...
    /**
        * 可用于纹理的资源。
        */
    export type TTextureSource = ArrayBuffer | ArrayBufferView | IImage | GPUImageCopyExternalImageSource;
    /**
        * 外部需要注入的下载器接口。
        */
    ...
    export interface IAttachmentAction {
            /**
                * 读取操作。
                */
            loadAction?: ELoadAction;
            /**
                * 存储操作。
                */
            storeAction?: EStoreAction;
            /**
                * 模板读取操作。
                */
            stencilLoadAction?: ELoadAction;
            /**
                * 模板存储操作。
                */
            stencilStoreAction?: EStoreAction;
            /**
                * 用于清屏的颜色值。
                *
                * @default [0,0,0,0]
    ...
    export interface IBufferHandle extends IHandle {
            flush(): void;
            createMappedMemory(): ArrayBuffer;
            upload(data: ArrayBuffer | ArrayBufferView, byteOffset: number): void;
    }
    export interface ITextureHandle extends IHandle {
            retrieve(data: ArrayBuffer | ArrayBufferView, region: ITextureSubRegion): void;
            upload(data: TTextureSource, region: ITextureSubRegion): void;
            updateSampler(sampler: ITextureSamplerOptions): void;
    }
    export interface IDescriptorGroupHandle extends IHandle {
            setBufferAt(index: number, buffer: IHandle, byteOffset: number): void;
            setTextureAt(index: number, texture: IHandle): void;
    }
    export interface IRenderComponentHandle extends IHandle {
            setSharedDirty(): void;
    }
    export interface IRenderCameraHandle extends IHandle {
            setSharedDirty(): void;
            updateMatrices(): void;
    }
    export interface IScalableListHandle extends IHandle {
    ...
    /**
        * Actions编码设计。
        * 返回一段共享内存，分两部分。
        * 第一部分是当帧的所有Action指令编码：
        *   |type|dataStart|dataLength|
        * 第二部分是数据部分，按照第一部分的dataStart和dataLength分段：
        * 对于bool或float数据：
        *   |change0|data0|change1|data1|...|
        * 对于transform：
        *   |pos0|quat0|pos1|quat1|...|
        */
    export const XRActionsSchemas: {
            confirm: string;
            cancel: string;
            menu: string;
    };
    export interface IXRLocationPose {
            position?: Float32Array;
            orientation?: Float32Array;
            dir?: Float32Array;
    }
    export interface IXRHandPose {
            left?: Float32Array;
            right?: Float32Array;
    }
    export enum EXRInput {
            Eye = 0,
            Controller = 1
    }
    export type TXRActionType = keyof typeof XRActionsSchemas;
    export interface IXRAction {
            type: TXRActionType;
            value: Float32Array;
            changed: boolean;
    }
    export interface IXRInput {
            type: EXRInput;
            id: number;
            transform: IXRLocationPose;
            actions: IXRAction[];
    }
    export interface IXRShoesInfo {
            foot: 'left' | 'right';
            transform: Float32Array;
    }
    export interface IXREnv {
            readonly supported: boolean;
            readonly viewChanged: boolean;
            readonly viewCount: number;
            readonly posMatrix: Float32Array;
            readonly near: number;
            readonly far: number;
            readonly fov: number;
            readonly aspect: number;
            getRenderPass(index: number): IHandle;
            getViewMatrix(index: number): Float32Array;
            getProjMatrix(index: number): Float32Array;
            queryHands(ts: number): IXRHandPose[];
            queryInputs(ts: number): IXRInput[];
            update?(): void;
            checkShoesInfo?(): IXRShoesInfo;
    }
...
declare module 'XrFrame/konata/lib/index' {
    /**
        * index.ts
        *
        *         * @Date    : 2020/8/18 下午4:48:36
        */
    export * from 'XrFrame/konata/lib/frontend';
    export * from 'XrFrame/konata/lib/backend/interface';
...
declare module 'XrFrame/components/text/types' {
    ...
    export interface IRenderData {
        vertexBuffer?: Konata.VertexBuffer;
        indexBuffer?: Konata.IndexBuffer;
        vertexNum?: number;
        indiceNum?: number;
        texture?: number;
    }
...
declare module 'XrFrame/components/text/typesetting' {
    ...
    import { IGlyph } from 'XrFrame/glyph';
    export function Typesetting(glyphs: Array<IGlyph>, batchArrays: Array<Array<ICharacterData>>, batchIndexs: Array<number>, wrapWidth: number, wrapHeight: number, lineHeight: number, anchor: Array<number>, padding: Array<number>, vertAlign: EVertAlignment, horzAlign: EHorzAlignment): void;
}

declare module 'XrFrame/components/text/fillRenderData' {
    import { ICharacterData } from "XrFrame/components/text/types";
    export function FillRenderData(vertexF32: Float32Array, indexU16: Uint16Array, batchArray: Array<ICharacterData>): void;
}
...
declare module 'XrFrame/loader/glTF/geometry/GLTFMeshesNode' {
    ...
    export default class GLTFMeshesNode extends GLTFArrayNode<ChildNode> {
        ...
        get nodeName(): string;
        preload: (prerequisites: [materials: GLTFMaterialsLoaded, accessors: GLTFAccessorsLoaded, vbMap: Map<string, [ArrayBuffer, Konata.VertexLayout, object]>]) => Promise<GLTFMeshesLoaded>;
...
declare module 'XrFrame/konata/lib/frontend/component/MeshRendererComponent' {
    /**
      * MeshRendererComponent.ts
      *
      *       * @Date    : 9/3/2020, 7:54:23 PM
      */
    import { EMeshRenderType } from 'XrFrame/konata/lib/backend';
    import NativeObject from 'XrFrame/konata/lib/frontend/shared/NativeObject';
    import Entity3D from 'XrFrame/konata/lib/frontend/entity/Entity3D';
    import Entity2D from 'XrFrame/konata/lib/frontend/entity/Entity2D';
    import UniformBlock from 'XrFrame/konata/lib/frontend/resource/UniformBlock';
    import VertexBuffer from 'XrFrame/konata/lib/frontend/resource/VertexBuffer';
    import IndexBuffer from 'XrFrame/konata/lib/frontend/resource/IndexBuffer';
    import Material from 'XrFrame/konata/lib/frontend/resource/Material';
    import SkinnedSkeletonComponent from 'XrFrame/konata/lib/frontend/component/SkinnedSkeletonComponent';
    import CullingComponent from 'XrFrame/konata/lib/frontend/component/CullingComponent';
    export default class MeshRendererComponent extends NativeObject {
        ...
        }): import('XrFrame/konata/lib/backend').IRenderComponentHandle;
        changeMacros(macros?: {
            [name: string]: string | number | boolean;
        }): void;
        ...
        fastSet(vertexes: VertexBuffer[], indexes: IndexBuffer[], materials: Material[], startIndexes: number[], numIndices: number[]): void;
        setDirty(): void;
...
declare module 'XrFrame/konata/lib/frontend/resource/renderEnv' {
    /**
      * renderEnv.ts
      *
      *       * @Date    : 1/18/2021, 3:53:26 PM
      */
    import { EMeshRenderType, EUniformType, IAttachmentAction, IFeatures, IRenderEnv, IView, TCompressTexture } from 'XrFrame/konata/lib/backend';
    import CameraComponent from 'XrFrame/konata/lib/frontend/component/CameraComponent';
    import ScalableList from 'XrFrame/konata/lib/frontend/resource/ScalableList';
    import Effect from 'XrFrame/konata/lib/frontend/resource/Effect';
    import RenderPass from 'XrFrame/konata/lib/frontend/resource/RenderPass';
    import Texture from 'XrFrame/konata/lib/frontend/resource/Texture';
    import UniformBlock from 'XrFrame/konata/lib/frontend/resource/UniformBlock';
    export class RenderEnv {
        ...
        beginFrame(): void;
        endFrame(): void;
        clearView(view: IView, renderPass: RenderPass, clearActions: IAttachmentAction[]): void;
        cullLightCSM(camera: CameraComponent, params: Float32Array, result: ScalableList): Float32Array;
        ...
        getErrors(): string[];
        setFaultTexture2D(texture: Texture): void;
        setFaultTextureCube(texture: Texture): void;
        setFaultTexture3D(texture: Texture): void;
        setFaultEffect(effect: Effect): void;
    }
    const renderEnv: RenderEnv;
    export default renderEnv;
}

declare module 'XrFrame/konata/lib/frontend/resource/KBuffer' {
    /**
        * KBuffer.ts
        *
        *         * @Date    : 2023/8/24 15:59:10
        */
    import { EBufferType, EBufferUsage, IBufferHandle, IBufferOptions } from 'XrFrame/konata/lib/backend';
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
    export default class KBuffer extends PureResource<IBufferHandle> {
            static CREATE_FROM_DATA(data: ArrayBuffer | ArrayBufferView, type: EBufferType, usage: EBufferUsage, debugName?: string): KBuffer;
            get byteSize(): number;
            /**
                * 类型为{@link EBufferType.DoubleBuffer}时，共享的内存数据。
                * 注意前`4`个字节是脏位。
                */
            ...
            /**
                * @param options 创建参数。
                */
            constructor(options: IBufferOptions);
            update(data: ArrayBuffer | ArrayBufferView, byteOffset?: number): void;
    }
}

declare module 'XrFrame/konata/lib/frontend/component/AnimatorComponent' {
    import NativeObject from 'XrFrame/konata/lib/frontend/shared/NativeObject';
    import Entity3D from 'XrFrame/konata/lib/frontend/entity/Entity3D';
    import AnimationClipModel from 'XrFrame/konata/lib/frontend/resource/AnimationClipModel';
...
declare module 'XrFrame/konata/lib/frontend/component/CameraComponent' {
    /**
      * CameraComponent.ts
      *
      *       * @Date    : 9/3/2020, 7:54:04 PM
      */
    import { IRenderCameraHandle, IView } from 'XrFrame/konata/lib/backend';
    import NativeObject from 'XrFrame/konata/lib/frontend/shared/NativeObject';
    import Entity3D from 'XrFrame/konata/lib/frontend/entity/Entity3D';
    import Entity2D from 'XrFrame/konata/lib/frontend/entity/Entity2D';
    import ScalableList from 'XrFrame/konata/lib/frontend/resource/ScalableList';
    ...
    export default class CameraComponent extends NativeObject {
        ...
        protected _handle: IRenderCameraHandle;
        get active(): boolean;
        ...
        draw(renderList: ScalableList, lightMode: string, renderPass: RenderPass, drawStart?: number, drawEnd?: number): void;
...
declare module 'XrFrame/konata/lib/frontend/component/CullingComponent' {
    import Entity3D from 'XrFrame/konata/lib/frontend/entity/Entity3D';
    import Entity2D from 'XrFrame/konata/lib/frontend/entity/Entity2D';
    import PoolObject from 'XrFrame/konata/lib/frontend/pool/PoolObject';
    import PoolManager from 'XrFrame/konata/lib/frontend/pool/PoolManager';
...
declare module 'XrFrame/konata/lib/frontend/component/SkinnedSkeletonComponent' {
    import NativeObject from 'XrFrame/konata/lib/frontend/shared/NativeObject';
    import SkeletonBoneInverseModel from 'XrFrame/konata/lib/frontend/resource/SkeletonBoneInverseModel';
    import Entity3D from 'XrFrame/konata/lib/frontend/entity/Entity3D';
...
declare module 'XrFrame/konata/lib/frontend/component/DynamicBonesComponent' {
    import NativeObject from 'XrFrame/konata/lib/frontend/shared/NativeObject';
    import Entity3D from 'XrFrame/konata/lib/frontend/entity/Entity3D';
...
declare module 'XrFrame/konata/lib/frontend/entity/Entity2D' {
    import PoolObject from 'XrFrame/konata/lib/frontend/pool/PoolObject';
    import PoolManager from 'XrFrame/konata/lib/frontend/pool/PoolManager';
...
declare module 'XrFrame/konata/lib/frontend/entity/Entity3D' {
    import PoolObject from 'XrFrame/konata/lib/frontend/pool/PoolObject';
    import PoolManager from 'XrFrame/konata/lib/frontend/pool/PoolManager';
...
declare module 'XrFrame/konata/lib/frontend/resource/AnimationClipModel' {
    import DataModel from 'XrFrame/konata/lib/frontend/resource/DataModel';
    export default class AnimationClipModel extends DataModel {
        setAnimationClip(ab: ArrayBuffer): void;
    }
}

declare module 'XrFrame/konata/lib/frontend/resource/AnimationClipBinding' {
    /**
    ...
    import Entity3D from 'XrFrame/konata/lib/frontend/entity/Entity3D';
    import AnimationClipModel from 'XrFrame/konata/lib/frontend/resource/AnimationClipModel';
    import { EUseDefaultAddedAction } from 'XrFrame/konata/lib/backend';
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
    import { INativeWorker } from 'XrFrame/konata/lib/backend/native/worker';
...
declare module 'XrFrame/konata/lib/frontend/resource/AnimatorControllerModel' {
    /**
      * AnimatorControllerModel.ts
      *
      *       */
    import AnimatorControllerStateModel from 'XrFrame/konata/lib/frontend/resource/AnimatorControllerStateModel';
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
    import AnimationClipBinding from 'XrFrame/konata/lib/frontend/resource/AnimationClipBinding';
...
declare module 'XrFrame/konata/lib/frontend/resource/AnimatorControllerStateModel' {
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
    import AnimationClipModel from 'XrFrame/konata/lib/frontend/resource/AnimationClipModel';
...
declare module 'XrFrame/konata/lib/frontend/resource/DataBuffer' {
    /**
      * DataBuffer.ts
      *
      *       * @Date    : 9/4/2020, 1:21:59 PM
      */
    import { IHandle } from 'XrFrame/konata/lib/backend';
    import NativeObject from 'XrFrame/konata/lib/frontend/shared/NativeObject';
...
declare module 'XrFrame/konata/lib/frontend/resource/DataModel' {
    /**
      * DataModel.ts
      *
      *       * @Date    : 9/4/2020, 1:18:13 PM
      */
    import { EDataModelType } from 'XrFrame/konata/lib/backend';
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
...
declare module 'XrFrame/konata/lib/frontend/resource/Effect' {
    /**
      * Effect.ts
      *
      *       * @Date    : 9/9/2020, 5:49:54 PM
      */
    import { EBlendFactor, EBlendEquation, ECullMode, ECompareFunc, EPrimitiveType, EStencilOp } from 'XrFrame/konata/lib/backend';
    import NativeObject from 'XrFrame/konata/lib/frontend/shared/NativeObject';
...
declare module 'XrFrame/konata/lib/frontend/resource/Material' {
    /**
      * Material.ts
      *
      *       * @Date    : 9/4/2020, 6:41:13 PM
      */
    import { EBlendFactor, EBlendEquation, ECompareFunc, ECullMode, EStencilOp, EPrimitiveType } from 'XrFrame/konata/lib/backend';
    import UniformBlock from 'XrFrame/konata/lib/frontend/resource/UniformBlock';
    import NativeObject from 'XrFrame/konata/lib/frontend/shared/NativeObject';
    import Effect from 'XrFrame/konata/lib/frontend/resource/Effect';
...
declare module 'XrFrame/konata/lib/frontend/resource/RenderPass' {
    /**
      * RenderPass.ts
      *
      *       * @Date    : 9/4/2020, 6:46:04 PM
      */
    import { IAttachment } from 'XrFrame/konata/lib/backend';
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
    import Texture from 'XrFrame/konata/lib/frontend/resource/Texture';
    ...
    export default class RenderPass extends PureResource {
        ...
        static SCREEN2_RENDER_PASS: RenderPass;
        get attachments(): IAttachment[];
        constructor(options: IRenderPassOptions);
    }
}

declare module 'XrFrame/konata/lib/frontend/resource/SkeletonBoneInverseModel' {
    import DataModel from 'XrFrame/konata/lib/frontend/resource/DataModel';
...
declare module 'XrFrame/konata/lib/frontend/resource/Texture' {
    /**
        * Texture.ts
        *
        *         * @Date    : 9/4/2020, 2:35:42 PM
        */
    import { ETextureFormat, ETextureType, EWrapMode, EFilterMode, TTextureSource, ITextureHandle } from 'XrFrame/konata/lib/backend';
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
    /**
    ...
    export interface ITextureOptions {
            ...
            anisoLevel?: number;
            /**
                * 用途，可以多个{@link ETextureUsage}或起来。
                */
            usage?: number;
            /**
                * @internal
    ...
    /**
        * 纹理资源。
        */
    export default class Texture extends PureResource<ITextureHandle> {
...
declare module 'XrFrame/konata/lib/frontend/resource/UniformBlock' {
    /**
        * UniformBlock.ts
        *
        *         * @Date    : 9/4/2020, 2:34:36 PM
        */
    import { IDescriptorGroupHandle } from 'XrFrame/konata/lib/backend';
    import UniformDescriptor from 'XrFrame/konata/lib/frontend/resource/UniformDescriptor';
    import Texture from 'XrFrame/konata/lib/frontend/resource/Texture';
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
    import KBuffer from 'XrFrame/konata/lib/frontend/resource/KBuffer';
    /**
        * 存储Uniform的一个区块。
        */
    export default class UniformBlock extends PureResource<IDescriptorGroupHandle> {
            /**
                * @internal
                */
            ...
            protected _createNativeObj(descriptor: UniformDescriptor): any;
            /**
                * 是否包含某个成员uniform。
                */
            ...
            /**
                * 设置某个成员uniform。
                */
            setUniform(key: string, value: ArrayLike<number> | number): boolean;
            /**
                * 设置某个纹理。
                */
            ...
            /**
                ...
                */
            getUniform(key: string): Float32Array | Uint32Array | number;
            /**
...
declare module 'XrFrame/konata/lib/frontend/resource/UniformDescriptor' {
    /**
        * UniformDescriptor.ts
        *
        *         * @Date    : 9/4/2020, 2:34:50 PM
     */
    import { EUniformType, IDescriptorGroupLayoutOptions } from 'XrFrame/konata/lib/backend';
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
    export interface IUniformExtraLayout {
            index: number;
            byteSizeExcludeDynamicArray: number;
            byteOffsets: {
                    [key: string]: number;
            };
    }
    ...
    export default class UniformDescriptor extends PureResource {
            ...
            /**
                ...
                */
            get layout(): {
                    [key: string]: [EUniformType, number, number, number, boolean];
            };
            /**
                * @internal
                */
            ...
            /**
                ...
                */
            get ubName0(): string;
            constructor(options: IDescriptorGroupLayoutOptions);
            /**
                * @internal
                */
            hasUniform(key: string): boolean;
            /**
                * @internal
                */
            ...
            /**
                * @internal
                */
            getUniformLayout(name: string): [EUniformType, number, number, number, boolean];
            /**
                * @internal
                */
            /**
...
declare module 'XrFrame/konata/lib/frontend/resource/IndexBuffer' {
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
    import KBuffer from 'XrFrame/konata/lib/frontend/resource/KBuffer';
    export default class IndexBuffer extends PureResource {
        get byteSize(): number;
        constructor(_buffer: KBuffer, _byteOffset?: number, is32bits?: boolean);
        update(data: ArrayBuffer | ArrayBufferView, byteOffset: number): void;
    }
}

declare module 'XrFrame/konata/lib/frontend/resource/VertexBuffer' {
    import VertexLayout from 'XrFrame/konata/lib/frontend/resource/VertexLayout';
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
    import KBuffer from 'XrFrame/konata/lib/frontend/resource/KBuffer';
    /**
      * 顶点数据。
    ...
    export default class VertexBuffer extends PureResource {
        ...
        constructor(_buffer: KBuffer, layout: VertexLayout, _byteOffset?: number);
        update(data: ArrayBuffer | ArrayBufferView, byteOffset: number): void;
    }
}

declare module 'XrFrame/konata/lib/frontend/resource/VertexLayout' {
    /**
        * VertexLayout.ts
        *
        *         * @Date    : 9/4/2020, 5:01:51 PM
        */
    import { IVertexLayoutOptions, EVertexLayoutUsage } from 'XrFrame/konata/lib/backend';
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
    /**
        * 顶点布局描述。
        */
    export default class VertexLayout extends PureResource {
            ...
            getConfigByName(name: string): {
                    name: string;
                    format: import('XrFrame/konata/lib/backend').EVertexFormat;
                    offset: number;
                    usage: EVertexLayoutUsage;
            };
            /**
...
declare module 'XrFrame/konata/lib/frontend/resource/ScalableList' {
    import PureResource from 'XrFrame/konata/lib/frontend/shared/PureResource';
    /**
...
declare module 'XrFrame/konata/lib/frontend/shared/crossContext' {
    /**
      * 跨域信息通道，用于主域和子域之间的通信。
      */
    class CrossContext {
...
declare module 'XrFrame/loader/glTF/geometry/GLTFMeshNode' {
    ...
    export default class GLTFMeshNode extends GLTFBaseNode {
        ...
        build(): void;
        preload(prerequisites: [materials: GLTFMaterialsLoaded, accessors: GLTFAccessorsLoaded, vbMap: Map<string, [ArrayBuffer, Konata.VertexLayout, object]>]): Promise<GLTFMeshLoaded>;
...
declare module 'XrFrame/loader/glTF/skins/GLTFSkinNode' {
    ...
    export interface GLTFSkinLoaded {
        inverseBindMatrices: Konata.SkeletonBoneInverseModel;
        skeleton?: number;
        joints: Array<number>;
        extras?: any;
    }
...
declare module 'XrFrame/loader/glTF/geometry/primitives/attributes/GLTFAttributesNode' {
    ...
    /**
        * GLTF.Attributes.Name -> Konata.Layout.Name
        */
    export function convertAttributeName(name: string): string;
    /**
        * GLTF.Attributes.Name -> Konata.Layout.Format
...
declare module 'XrFrame/loader/glTF/utils/types' {
    ...
    export namespace GLTF {
            ...
            interface VertexLayoutDesc extends Konata.IVertexLayoutOptions {
                    stride: number;
            }
            interface VertexProperties {
                    buffer: Float32Array;
                    layoutDesc: VertexLayoutDesc;
                    layout: Konata.VertexLayout;
                    macros: object;
...
declare module 'XrFrame/konata/lib/backend' {
    /**
      * index.ts
      *
      ...
      */
    export * from 'XrFrame/konata/lib/backend/interface';
    import { IImage, IXREnv } from 'XrFrame/konata/lib/backend/interface';
    import { IWorker } from 'XrFrame/konata/lib/backend/interface/IWorker';
...
declare module 'XrFrame/konata/lib/frontend/shared/NativeObject' {
    /**
      * NativeObject.ts
      *
...
declare module 'XrFrame/konata/lib/frontend/shared/PureResource' {
    /**
      * PureResource.ts
      *
      ...
      */
    import { IHandle } from 'XrFrame/konata/lib/backend';
    export default class PureResource<T extends IHandle = IHandle> {
        id: number;
        __handle: T;
        protected get _handle(): T;
        protected set _handle(value: T);
        destroy(): void;
    }
}

declare module 'XrFrame/konata/lib/frontend/pool/PoolObject' {
    import Pool from 'XrFrame/konata/lib/frontend/pool/Pool';
...
declare module 'XrFrame/konata/lib/frontend/pool/PoolManager' {
    /**
      * PoolManager.ts
      *
      ...
      */
    import { IHandle } from 'XrFrame/konata/lib/backend';
    import PoolObject, { INativePools } from 'XrFrame/konata/lib/frontend/pool/PoolObject';
...
declare module 'XrFrame/konata/lib/backend/native/worker' {
    import { IHandle, EMeshRenderType, INativeMap, ILongIntNativeMap, IGlyphInfo, IRenderEnv, EDracoDecodeType, DracoDecoded, IBufferOptions, IVertexLayoutOptions, EIndexType, IDescriptorGroupLayoutOptions, IBufferHandle, ITextureHandle, IDescriptorGroupHandle, IScalableListHandle, IRenderComponentHandle, IRenderCameraHandle, IView, IAttachmentAction, IKTextureOptions } from 'XrFrame/konata/lib/backend/interface';
    export interface INativeWorker {
        createBuffer(options: IBufferOptions): IBufferHandle;
        ...
        createTexture(options: IKTextureOptions): ITextureHandle;
        createDescriptorGroupLayout(options: IDescriptorGroupLayoutOptions): IHandle;
        createDescriptorGroup(layout: number): IDescriptorGroupHandle;
        ...
        createScalableList(initSize: number, onBackendEnlarge: () => void): IScalableListHandle;
    }
    export interface INativeWorker {
        createRenderPassFromAttachments(attachments: {
            texture: number;
            level?: number;
            slice?: number;
        }[]): IHandle;
    ...
    export interface INativeWorker {
        ...
        createRenderComponent(meshCount: number, uniformBlock: number, attachedNode: number, cullingId: number, meshRenderType: EMeshRenderType, macros?: string): IRenderComponentHandle;
    ...
    export interface INativeWorker {
        createRenderCamera(attachedNode: number, isUI?: boolean): IRenderCameraHandle;
...
declare module 'XrFrame/loader/glTF/geometry/primitives/GLTFPrimitivesNode' {
    ...
    export default class GLTFPrimitivesNode extends GLTFArrayNode<ChildNode> {
        ...
        get nodeName(): string;
        preload: (prerequisites: [materials: GLTFMaterialsLoaded, accessors: GLTFAccessorsLoaded, vbMap: Map<string, [ArrayBuffer, Konata.VertexLayout, object]>]) => Promise<GLTFPrimitivesLoaded>;
...
declare module 'XrFrame/konata/lib/backend/interface/IWorker' {
    /**
        * IWorker.ts
        *
        *         * @Date    : 12/3/2020, 4:45:58 PM
        */
    import { IHandle, EMeshRenderType, INativeMap, ILongIntNativeMap, IGlyphInfo, IVertexLayoutOptions, IEventBridge, IDownloader, IFontSetting, IRenderEnv, IEngineSettings, EDracoDecodeType, DracoDecoded, IBufferOptions, IKTextureOptions, IVertexBuffOptions, IIndexBuffOptions, IDescriptorGroupLayoutOptions, IDrawCameraOptions, IClearOptions, IAttachment, IBufferHandle, ITextureHandle, IDescriptorGroupHandle, IRenderComponentHandle, IRenderCameraHandle, IScalableListHandle, ICullLightCSMOptions } from 'XrFrame/konata/lib/backend/interface';
    global {
    ...
    export interface IWorker {
            createBuffer(options: IBufferOptions): IBufferHandle;
            createVertexLayout(options: IVertexLayoutOptions): IHandle;
            createVertexBuffer(options: IVertexBuffOptions): IHandle;
            createIndexBuffer(options: IIndexBuffOptions): IHandle;
            createTexture(options: IKTextureOptions): ITextureHandle;
            createDescriptorGroupLayout(descriptor: IDescriptorGroupLayoutOptions): IHandle;
            createDescriptorGroup(layout: IHandle): IDescriptorGroupHandle;
    ...
    export interface IWorker {
            createRenderCamera(attachedNodeId: number, isUI?: boolean): IRenderCameraHandle;
    }
    export interface IWorker {
            createRenderPassFromAttachments(attachments: IAttachment[]): IHandle;
    }
    export interface IWorker {
            createAnimationClipModel(buffer: ArrayBuffer): IHandle;
            createBoneInverseModel(buffer: ArrayBuffer): IHandle;
    ...
    export interface IWorker {
            ...
            drawCamera(options: IDrawCameraOptions): void;
            /**
                * @returns |lightMatrix0|lightMatrix1|lightMatrix2|lightMatrix3|
                */
            cullLightCSM(options: ICullLightCSMOptions): Float32Array;
            start?(): void;
            submit(): void;
            createWeakRef<T>(wrapper: T): {
                    deref: () => T;
...
declare module 'XrFrame/konata/lib/frontend/pool/Pool' {
    import { IHandle } from 'XrFrame/konata/lib/backend';
    import NativeObject from 'XrFrame/konata/lib/frontend/shared/NativeObject';
...
declare module 'XrFrame/core/utils' {
    ...
    export function wxPromiseWrapper<T = any>(executor: any, args: any, methodName?: string): Promise<T>;
